...
function Footer() {
  return (
    <div className="w-full flex  h-screen bg-white p-10">
      <div className="w-1/2 flex flex-col h-full justify-between font-founders-grotesk uppercase text-black">
        <div className="headings">
          <h1 className="-mb-6  text-[8vw] leading-none  font-bold tracking-tighter">
            eye-
          </h1>
          <h1 className="-mb-6  text-[8vw] leading-none  font-bold tracking-tighter">
            opening
      ...
      <div className="w-1/2  text-black">
        <h1 className="  text-[6vw] leading-none  font-bold tracking-tighter font-founders-grotesk uppercase">presentations</h1>
        <div className="dates font-neue-montreal mt-10 pl-1">
            <a className="block text-xl font-light" href="">Instagram</a><a className="block text-xl font-light" href="">Facebook</a><a className="block text-xl font-light" href="">Linkedin</a>
        </div>
      </div>
    </div>
  );
